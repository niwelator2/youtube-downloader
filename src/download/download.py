...
# Function to download a single video in a separate thread (for GUI)
def download_single_video_threaded(
    ...
    """
    Wrapper to download a single video in a separate thread.
    """
    try:
        threading.Thread(
            ...
            args=(
                ...
                save_directory,
                current_video,
                set(),  # Empty set for downloaded_titles
                text_area,
                progress_var,
                progress_bar,
                progress_label,
